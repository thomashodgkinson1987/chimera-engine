...
This document is the single source of truth for all coding, documentation, and workflow conventions used in the Chimera Engine project. Adhering to these standards ensures our codebase remains clean, consistent, and easy to navigate.
